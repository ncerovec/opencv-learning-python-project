...
for p in training_names:
    training_paths1 = os.listdir("../DATA/train/"+p)
    for j in training_paths1:
        training_paths.append("../DATA/train/"+p+"/"+j)
        names_path.append(p)
...
for p in training_paths:
    ...
    if names_path[i]=='airplane':
        train_labels.append(1)
    if names_path[i]=='automobile':
        train_labels.append(2)
    if names_path[i]=='bird':
        train_labels.append(3)
    if names_path[i]=='cat':
        train_labels.append(4)
    if names_path[i]=='deer':
        train_labels.append(5)
    if names_path[i]=='dog':
        train_labels.append(6)
    if names_path[i]=='frog':
        train_labels.append(7)
    if names_path[i]=='horse':
        train_labels.append(8)
    if names_path[i]=='ship':
        train_labels.append(9)
    if names_path[i]=='truck':
